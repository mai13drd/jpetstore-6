...
public class OrderServiceTest {
   ...
   /*
    * This class runs with the MockitoJUnitRunner.class. If you run KoPeMe-performanceTests with another runner than the
    * de.dagere.kopeme.junit.testrunner.PerformanceTestRunnerJUnit, you have to set this rule!
    */
   @Rule()
